...
from utils.save_content import save_comments
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--browser', type=str, default='default', help='Browser to get authkey')
    ...
    # 保存文章
    save_comments(args.blog_id, args.post_id, args.save_path, rewrite=args.rewrite, authkey=authkey)